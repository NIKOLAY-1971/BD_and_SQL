DROP SCHEMA IF EXISTS home4;
CREATE SCHEMA IF NOT EXISTS home4;
USE home4;
...
FROM shops
left join cats
ON  shops.id =  cats.shops_id  AND cats.`name` != 'Murzik' and cats.`name` != 'Zuza'
WHERE cats.id IS NULL;

#4.Вывести название и цену для всех анализов, которые продавались 5 февраля 2020 и всю следующую неделю.
SELECT an_name,  ord_datetime, an_price
FROM analysis
JOIN Orders 
ON analysis.an_id = Orders.ord_an
WHERE Orders.ord_datetime >= '20-02-05 00:00:00';